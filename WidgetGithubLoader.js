(function(){
    ...
    function main() {
        buildWidgetHtml(function(){
            ...
            widgetJS.src = "./WidgetGithub.js"; //widgetURL
    ...
    function loadTemplate(callback) {
		...
		ajax.open("GET","https://raw.githubusercontent.com/zamarrowski/Widget-Github-Repositories/master/widgetGithubRepos.html");
		ajax.send();
